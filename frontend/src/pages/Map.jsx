...
export default function Map() {
  ...
  <div className="w-full max-w-5xl mx-auto mt-6">
    ...
    <div className="relative">
      ...
      {selectedArea && (
        <div
          className={`absolute bg-white text-black p-3 rounded-lg shadow-lg z-50 w-72 transition-all duration-300 ease-out ${
            visibleArea ? "animate-fade-in" : "animate-fade-out"
          }`}
          style={{
