  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl text-blue-600 font-bold">🎛️ Admin Dashboard</h1>
        <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <h2 className="text-lg text-blue-600 font-semibold mb-2">🎤 Gérer les artistes</h2>
        ...
        <div
          ...
          className="p-4 bg-gray-100 rounded shadow cursor-pointer hover:bg-gray-200 transition"
        >
          <h2 className="text-lg text-blue-600 font-semibold mb-2">🎟️ Gérer les événements</h2>
        ...
        <div
          ...
          className="p-4 bg-gray-100 rounded shadow cursor-pointer hover:bg-gray-200 transition"
        >
          <h2 className="text-lg text-blue-600 font-semibold mb-2">🗺️ Gérer les zones</h2>
